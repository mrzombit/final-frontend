...
var CellRenderer = /** @class */ (function () {
    ...
    CellRenderer.prototype.calculateFormula = function (args) {
        ...
        var eventArgs = { action: 'refreshCalculate', value: args.cell.formula, rowIndex: args.rowIdx, colIndex: args.colIdx, isFormula: isFormula, sheetIndex: args.sheetIndex, isRefreshing: args.isRefreshing, isDependentRefresh: args.isDependentRefresh };
    ...
    CellRenderer.prototype.refresh = function (rowIdx, colIdx, lastCell, element, checkCF, checkWrap, skipFormatCheck) {
        var sheet = this.parent.getActiveSheet();
