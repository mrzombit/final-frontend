...
import { getSingleSelectedRange, getCell, getSheetIndex } from '../index';
...
var WorkbookFormula = /** @class */ (function () {
    ...
    WorkbookFormula.prototype.performFormulaOperation = function (args) {
        ...
        switch (action) {
            ...
            case 'refreshCalculate':
                ...
                args.isFormulaDependent = this.refreshCalculate(args.rowIndex, args.colIndex, args.value, args.isFormula, args.sheetIndex, args.isRefreshing, args.isDependentRefresh);
    ...
    WorkbookFormula.prototype.refreshCalculate = function (rowIdx, colIdx, value, isFormula, sheetIdx, isRefreshing, isDependentRefresh) {
    ...
    WorkbookFormula.prototype.autoCorrectCellRef = function (formula) {
        var rightParens = formula.lastIndexOf(')');
        var refCorrectObj;
        if (rightParens > -1 && formula.split(')').length === 2) {
            ...
            if (leftParens > -1) {
                var formulaArgs = formula.substring(leftParens + 1, rightParens);
