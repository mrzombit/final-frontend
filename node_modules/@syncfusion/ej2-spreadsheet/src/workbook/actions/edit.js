...
var WorkbookEdit = /** @class */ (function () {
    ...
    WorkbookEdit.prototype.performEditOperation = function (args) {
        ...
        switch (action) {
            case 'updateCellValue':
                args.isFormulaDependent = this.updateCellValue(args.address, args.value, args.sheetIndex, args.isValueOnly, args.formula, args.skipFormatCheck);
                break;
        }
    };
    ...
    WorkbookEdit.prototype.updateCellValue = function (address, value, sheetIdx, isValueOnly, formula, skipFormatCheck) {
        ...
        if (!isValueOnly) {
            ...
            if (value === '#SPILL!') {
                ...
                if (isFormula) {
                    ...
                    value = cell.value;
                    var formula_1 = cell.formula.toLowerCase();
                    if (formula_1 === '=now()' && !cell.format) {
                        cell.format = 'M/d/yyyy h:mm';
                    }
                    else if (formula_1.includes('=time(') && !cell.format) {
