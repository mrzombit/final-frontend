...
.e-bigger .e-spreadsheet .e-hyperlink-dlg.e-dialog .e-dlg-header-content {
...
.e-ribbon .e-tab .e-toolbar, .e-ribbon .e-tab .e-toolbar-items {
  background-color: #faf9f8;
}
.e-ribbon .e-tab .e-hscroll .e-scroll-nav.e-scroll-left-nav, .e-ribbon .e-tab .e-hscroll .e-scroll-nav.e-scroll-right-nav {
  background-color: #faf9f8;
}
.e-ribbon .e-drop-icon {
  color: #605e5c;
