    ...
    Diagram.prototype.findNodeInLane = function (nodeId) {
        ...
        for (var i = 0; i < this.nodes.length; i++) {
            if (this.nodes[parseInt(i.toString(), 10)].shape.type !== 'SwimLane') {
                ...
                var node = this.nodes[parseInt(i.toString(), 10)].shape;
                if (node.lanes && node.lanes.length > 0) {
                    for (var j = 0; j < node.lanes.length; j++) {
                        if (node.lanes[parseInt(j.toString(), 10)].children && node.lanes[parseInt(j.toString(), 10)].children.length > 0) {
                            for (var k = 0; k < node.lanes[parseInt(j.toString(), 10)].children.length; k++) {
        ...
        for (var _i = 0, _a = Object.keys(this.layerZIndexTable); _i < _a.length; _i++) {
            ...
            for (var _b = 0, _c = Object.keys(id || layer.zIndexTable); _b < _c.length; _b++) {
                ...
                if (renderNode && !(renderNode.parentId) && layer.visible &&
                    ...
                    renderer.renderElement(renderNode.wrapper, canvas, htmlLayer, (!renderer.isSvgMode && transform && this.mode !== 'SVG') ? transformValue : undefined, undefined, undefined, status_1 && (!this.diagramActions || isOverView), undefined, undefined, getCenterPoint);
                }
            }
        }
    };
