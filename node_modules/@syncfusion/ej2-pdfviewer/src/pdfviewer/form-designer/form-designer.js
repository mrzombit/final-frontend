...
var FormDesigner = /** @class */ (function () {
    ...
    */
    ...
    FormDesigner.prototype.setCheckBoxState = function (event) {
        if ((Browser.isDevice) ? (event.target.className === '' || event.target.className === 'e-pv-checkbox-outer-div') && event.currentTarget.className === 'e-pv-checkbox-outer-div' && !this.pdfViewer.designerMode : !this.pdfViewer.designerMode) {
            var minCheckboxWidth = 20;
            var isChecked = false;
    ...
    */
    ...
    FormDesigner.prototype.downloadFormDesigner = function () {
        ...
        if (data) {
            ...
            for (var j = 0; j < this.pdfViewer.formFieldCollection.length; j++) {
                var _loop_1 = function (k) {
                    var items = this_1.loadedFormFieldValue(this_1.pdfViewer.formFieldCollections[k], this_1.pdfViewer.formFieldCollection[j]);
                    var nonRenderField = formFieldsData.filter(function (value) {
                ...
                var this_1 = this;
                for (var k = 0; k < this.pdfViewer.formFieldCollections.length; k++) {
                    _loop_1(k);
                }
            }
     ...
     * @private
    */
    FormDesigner.prototype.loadedFormFieldValue = function (currentData, items) {
