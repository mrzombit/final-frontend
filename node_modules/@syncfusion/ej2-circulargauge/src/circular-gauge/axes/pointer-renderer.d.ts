...
export declare class PointerRenderer {
     ...
     * @private
     */
    performTextAnimation(element: HTMLElement, start: number, end: number, axis: Axis, pointer: Pointer): void;
    /**
     ...
     * @private
     */
    performNeedleAnimation(element: HTMLElement, start: number, end: number, axis: Axis, pointer: Pointer): void;
    /**
     ...
     * @private
     */
    performRangeBarAnimation(element: HTMLElement, start: number, end: number, axis: Axis, pointer: Pointer): void;
    /**
     *
     * @returns {void}
     * @private
