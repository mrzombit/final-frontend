...
class DragAndDrop {
    ...
    dragStop(e) {
        ...
        if (this.dragObj.targetClone.parentElement) {
            const isMultipleDrag = (this.dragObj.selectedCards && this.dragObj.selectedCards.length > 1
                && this.parent.sortSettings.sortBy === 'Index');
            const className = !isMultipleDrag ? '.' + CARD_CLASS + ':not(.' + DRAGGED_CARD_CLASS + '),.' + DROPPED_CLONE_CLASS :
                '.' + CARD_CLASS + ',.' + DROPPED_CLONE_CLASS;
